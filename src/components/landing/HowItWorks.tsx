    ...
    <section className="how" id="how">
      <div className="wrap">
        <div className="head">
          ...
          <p className="lead">Van "ik heb geen idee waar ik moet beginnen" naar een advertentie die mensen zien — op de vaste plaatsingsdag in jouw gemeente.</p>
        </div>
          ...
          <div className="steps">
            ...
            <div className="stepcard">
              ...
              <div>
                ...
                <p>ESH Media zoekt de gemeenten op waar jouw klanten wonen. Bij elke gemeente zie je het bereik, de richtprijs en hoeveel displays er nog vrij zijn — dus je weet altijd wat je boekt en waar het hangt.</p>
              </div>
            </div>
            <div className="stepcard">
